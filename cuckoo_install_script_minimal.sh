...
echo "\n[*]XXXXXXXXXXXXXX Creating user “cuckoo” and add them to sudo \n"
# sudo adduser cuckoo
...
echo "\n[*]XXXXXXXXXXXXXX Installing Virtual Box 6.1 \n"
...
echo "\n[*]XXXXXXXXXXXXXX Creating and Configuring Host Only Network Adapter \n"
