...
echo "\n[*] This Script will skip certain commands. Cuckoo Analysis is not affected by skipped commands. Skipped commands are only those which automates certain things at reboot. \n"
...
echo "\n[*]Creating Host Only Network Adapter \n"
